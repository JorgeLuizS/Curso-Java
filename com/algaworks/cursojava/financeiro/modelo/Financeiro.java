...
public class Financeiro {
	...
	public static void main(String[] args) {
		...
		ContaPagar contaPagar2 = new ContaPagar("Compras do mês", 390d, LocalDate.of(2012, 5, 19), mercado);
		...
		ContaReceber contaReceber2 = new ContaReceber("Manutenção em sistema de conta online", 
			53200d, LocalDate.of(2012, 5, 13), telecom);
